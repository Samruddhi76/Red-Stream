      ...
      <div class="container">
        <ul class="contact-list">
          <li class="contact-item">
            ...
            <a href="mailto:bendugadesamruddhi@gmail.com" class="contact-link">bendugadesamruddhi@gmail.com</a>
          </li>
          <li class="contact-item">
            <ion-icon name="call-outline"></ion-icon>
            <a href="tel:+917558951351" class="contact-link">+91-7620151642</a>
          </li>
        </ul>
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            EMAIL : bendugadesamruddhi@gmail.com<br>
            </p>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+917052101786" class="footer-link">+91-7620151642</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:help@example.com" class="footer-link">bendugadesamruddhi@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
